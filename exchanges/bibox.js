/**
 * Bibox order book event emitter.
 */

const EventEmitter = require('events');
const request = require('request');
const config = require('config');
const debug = require('debug')('cointrage:order_book:bibox');
...
class BiboxOrderBook extends EventEmitter {
...
module.exports = new BiboxOrderBook();