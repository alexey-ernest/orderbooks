/**
 * BigOne order book event emitter.
 */

const EventEmitter = require('events');
const request = require('request');
const config = require('config');
const debug = require('debug')('cointrage:order_book:bigone');
...
class BigOneOrderBook extends EventEmitter {
...
module.exports = new BigOneOrderBook();