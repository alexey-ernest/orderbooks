/**
 * Bitgrail order book event emitter.
 *
...
const debug = require('debug')('cointrage:order_book:bitgrail');
...
class BitGrailOrderBook extends EventEmitter {
...
module.exports = new BitGrailOrderBook();