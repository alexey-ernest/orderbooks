/**
 * BTC Markets order book event emitter.
 */
...
const debug = require('debug')('cointrage:order_book:btcmarkets');
...
class BTCMarketsOrderBook extends EventEmitter {
...
module.exports = new BTCMarketsOrderBook();