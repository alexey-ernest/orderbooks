/**
 * C-cex order book event emitter.
 */

const EventEmitter = require('events');
const request = require('request');
const config = require('config');
const debug = require('debug')('cointrage:order_book:c-cex');
...
const getOrderBook = (market, ticker) => new Promise((resolve, reject) => {
    ...
    request({
        ...
        const res = {
            market: market,
            ticker: ticker,
            asks: body.result.sell.map(mapOrder),
            bids: body.result.buy.map(mapOrder)
        };
...
class CCexOrderBook extends EventEmitter {
...
module.exports = new CCexOrderBook();