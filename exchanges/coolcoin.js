/**
 * Coolcoin order book event emitter.
 *
...
const debug = require('debug')('cointrage:order_book:coolcoin');
...
class CoolCoinOrderBook extends EventEmitter {
...
module.exports = new CoolCoinOrderBook();