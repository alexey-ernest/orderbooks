/**
 * Gemini order book event emitter.
 *
...
const debug = require('debug')('cointrage:order_book:gemini');
...
class GeminiOrderBook extends EventEmitter {
...
module.exports = new GeminiOrderBook();