/**
 * TheRockTrading order book event emitter.
 *
...
const debug = require('debug')('cointrage:order_book:therocktrading');
...
class TheRockTradingOrderBook extends EventEmitter {
...
module.exports = new TheRockTradingOrderBook();