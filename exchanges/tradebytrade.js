/**
 * TradeByTrade order book event emitter.
 *
...
const debug = require('debug')('cointrage:order_book:tradebytrade');
...
class TradeByTradeOrderBook extends EventEmitter {
...
module.exports = new TradeByTradeOrderBook();